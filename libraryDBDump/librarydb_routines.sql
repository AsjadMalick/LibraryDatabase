...
--
/*!50003 DROP PROCEDURE IF EXISTS `select_test_procedure` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `select_test_procedure`()
BEGIN
SELECT * FROM librarydb.test_table;
END ;;
DELIMITER ;
...
-- Dump completed on 2020-03-27 21:53:39
